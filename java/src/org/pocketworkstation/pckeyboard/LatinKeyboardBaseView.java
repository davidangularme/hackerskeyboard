    ...
    public LatinKeyboardBaseView(Context context, AttributeSet attrs, int defStyle) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            case R.styleable.LatinKeyboardBaseView_keyHintColor:
                mKeyHintColor = a.getColor(attr, 0x00000000);
                break;
            ...
            case R.styleable.LatinKeyboardBaseView_backgroundDimAmount:
                mBackgroundDimAmount = a.getFloat(attr, 0.0f);
                break;
            case R.styleable.LatinKeyboardBaseView_backgroundAlpha:
                mBackgroundAlpha = 0;//a.getInteger(attr, 255);
                break;
...
//            }
    ...
    private void showKey(final int keyIndex, PointerTracker tracker) {
        ...
        Log.i(TAG, "davidkkk showKey() for " + this+"  index "+key);
