...
public class LatinKeyboard extends Keyboard {
    ...
    private Bitmap drawSynthesizedSettingsHintImage(
        ...
        transparentpainthack.setAlpha(0);
        
        
        final Canvas canvas = new Canvas(buffer);
        canvas.drawBitmap(buffer, 0, 0, transparentpainthack);
    ...
    class SlidingLocaleDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mHitThreshold) {
                ...
                paint.setColor(Color.TRANSPARENT);//mRes.getColor(R.color.latinkeyboard_feedback_language_text));
